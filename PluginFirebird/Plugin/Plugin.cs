...
using PluginFirebird.API.Discover;
using PluginFirebird.API.Factory;
using PluginFirebird.API.Read;
using PluginFirebird.API.Replication;
using PluginFirebird.API.Write;
using PluginFirebird.DataContracts;
using PluginFirebird.Helper;

namespace PluginFirebird.Plugin
{
    public class Plugin : Publisher.PublisherBase
    {
        ...
        /// <summary>
        /// Establishes a connection with Firebird.
        /// </summary>
        /// <param name="request"></param>
        /// <param name="context"></param>
        ...
        /// <summary>
        /// Configures replication writebacks to Firebird
        /// </summary>
        /// <param name="request"></param>
        /// <param name="context"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Prepares writeback settings to write to Firebird
        /// </summary>
        /// <param name="request"></param>
        /// <param name="context"></param>
        /// <returns></returns>
            ...
            IServerStreamWriter<RecordAck> responseStream, ServerCallContext context)
        {
            try
            {
                Logger.Info("Writing records to Firebird...");
                ...
                Logger.Info($"Wrote {inCount} records to Firebird.");
            }
            catch (Exception e)
            {
                Logger.Error(e, e.Message, context);
